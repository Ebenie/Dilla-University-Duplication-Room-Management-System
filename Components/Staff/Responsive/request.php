...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $double_sided = isset($_POST["double_sided"]) ? $_POST["double_sided"] : "no";
    // $num_photocopies = $_POST["photocopy"] ? $_POST["photocopy"] : "no";
    ...
    $sql = "INSERT INTO request (no_of_students, no_of_papers, no_of_stencil, is_double_sided, photocopy, reason,req_by, code) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

    // Prepare and bind the statement
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("iiisssss", $num_students, $num_papers, $num_stencils, $double_sided, $num_photocopies, $reason, $user_id, $code);

...
$approvedRequestsQuery = "SELECT COUNT(*) as approved FROM request WHERE req_by = ? AND req_status='approved'";
$rejectedRequestsQuery = "SELECT COUNT(*) as rejected FROM request WHERE req_by = ? AND req_status='rejected'";
$pendingRequests = "SELECT * FROM request WHERE req_by = ? AND req_status='pending' ORDER BY req_date DESC";

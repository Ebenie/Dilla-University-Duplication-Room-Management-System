...
$sql = "SELECT r.*, u.fname, u.mname, d.name
        ...
        WHERE r.duplication_approval = 'approved' AND r.final_status = 'pending' 
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="complete.php">
                        ...
                        <input type="text" name="user_input" placeholder="Enter the code here" required >
                        <button type="submit" name="action" value="complete" class="btn-update">Complete</button>
                    </form>
                </td>
            </tr>
        <?php endwhile; ?>

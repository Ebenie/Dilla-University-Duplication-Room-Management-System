...
$users = [];
if (!empty($dept_id)) {
    $stmt = $conn->prepare("SELECT * FROM users WHERE role = 'Duplication Room' ");
        ...
        <div class="main">
           <div class="topbar">
            ...
            <div class="main-content">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select id="role" name="role">
                            <option value="Duplication Room">Duplication Room Staff</option>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <center><h3>Your Duplication Room(Office) Staff Members </h3></center>
                <table>
                    <thead>
                        <tr>
                            <th>Username</th>
